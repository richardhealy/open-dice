...
export function createDie(type) {
    let mesh, body;
    const size = 1;
    switch (type) {
        case 'd4':
            mesh = createD4Mesh(size);
...
export function getDieValue(die, up) {
    let maxDot = -Infinity;
    let closestIndex = 0;
    ...
    if (die.type === 'd4') {
        ...
        const faceValues = D4_GEOMETRY.faceValues;
        ...
        return faceValues[closestIndex] || 1;
    } else if (die.type === 'd6') {
        const geometry = die.mesh.geometry;
        const faceValues = D6_GEOMETRY.faceValues;
        ...
        const geometry = die.mesh.geometry;
        const faceValues = D8_GEOMETRY.faceValues;
        ...
        const geometry = die.mesh.geometry;
        const faceValues = D20_GEOMETRY.faceValues;
        ...
        return parseInt(faceValues[closestIndex]) || 0;
    }
